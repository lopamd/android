...
public abstract class LifecycleLoggingActivity extends Activity {
    ...
    protected void onStart(){
    	...
    	super.onStart();
    	Log.d(TAG,
                "onStart(): activity onStart called");
    }
    ...
    protected void onResume(){
    	...
    	super.onResume();
    	Log.d(TAG,
                "onResume(): activity onResume called");
    }
    ...
    protected void onPause(){
    	...
    	super.onPause();
    	Log.d(TAG,
                "onPause(): activity onPause called");
    ...
    protected void onRestart(){
    	...
    	super.onRestart();
    	Log.d(TAG,
                "onRestart(): activity onRestart called");
    }
    ...
    protected void onDestroy(){
    	...
    	super.onDestroy();
    	Log.d(TAG,
                "onDestroy(): activity onDestroy called");
    }
