...
public class OutputStrategy {
    ...
    public void print(final String outputString) {
    	...
    	final MainActivity mainOutput = mOuterClass.get();
    	 	if (mainOutput == null)
    	 		return;
    	 	try {
     	 		mainOutput.print(outputString + "\n");
    	 	} catch (NullPointerException ex) {
    	 		errorLog("OutputStrategy",
    	 				 "print method of MainActivity Failed because of null Activity");
    	 	}
    }
