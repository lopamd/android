...
public interface VideoServiceProxy {
    ...
    public static final String VIDEO_META_PATH = "/meta";
    ...
    /**
     * Sends a POST request to update the Video metadata to the Video 
     * Web service using a two-way Retrofit RPC call.
     *
     * @param video meta-data
     * @return videoStatus indicating status of the updated video.
     */
    @POST (VIDEO_META_PATH)
    Response updateMetadata(@Body Video v);
