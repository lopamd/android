...
public class PlayPingPong implements Runnable {
    ...
    private Handler pingHandler,pongHandler;
    ...
    private Handler mPingPongHandlers[] = new Handler[2];
    ...
    protected CyclicBarrier mCyclicBarrier = new CyclicBarrier(2);
    /**
    ...
    class PingPongThread extends HandlerThread implements Handler.Callback {
        ...
        protected void onLooperPrepared() {
            ...
            Message mMessage = mPingPongHandlers[0].obtainMessage();
            mMessage.setTarget(mPingPongHandlers[0]);
            mMessage.obj=mPingPongHandlers[1];
        ...
        public boolean handleMessage(Message reqMsg) {
            ...
            if (mIterationsCompleted <= mMaxIterations) {
            	...
            	if (reqMsg.getTarget() == mPingPongHandlers[0]){
